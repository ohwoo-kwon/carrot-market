  ...
  return (
    <div className="bg-slate-400 xl:place-content-center py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      <div className="bg-white dark:bg-black flex flex-col justify-between p-6 rounded-3xl shadow-xl">
        ...
        <ul>
          {[0, 2, 1, 3].map((i) => (
            <div key={i} className="flex justify-between my-2">
              ...
              <span className="font-semibold dark:text-white">${i}</span>
            </div>
          ))}
        </ul>
        ...
        <button className="mt-5 bg-blue-500 dark:bg-black dark:border-white dark:border text-white p-3 text-center rounded-xl w-3/5 block mx-auto dark:hover:bg-white hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500">
          Checkout
        </button>
      </div>
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl group">
        <div className="portrait:bg-blue-500 landscape:bg-yellow-500 p-6 pb-14 xl:pb-40">
      ...
      <div className="bg-white p-6 rounded-3xl shadow-xl lg:col-span-2 xl:col-span-1">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between items-center">
            <span className="font-medium text-2xl">$213</span>
